...
According to data from the graph,
for array sizes less than length 9
linear Search is more efficient because
it does less comparisons.

And for array sizes more than length 9
binarySearch is more efficent because it
does less comparisons.
