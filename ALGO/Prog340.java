...
**/
  public Prog340() {
	...
	inputFile = null;
   	...
   	comboBoxList[2] = new String("Deliv B:  DFS");
   	comboBoxList[3] = new String("Deliv C:  Constraint Satisfaction");
   	comboBoxList[4] = new String("Deliv D:  Distances");
   	comboBoxList[5] = new String("exit");
